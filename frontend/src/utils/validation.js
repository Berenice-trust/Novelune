// Копия backend/shared/validation.js для фронта
// Можно импортировать в компоненты форм
...
export const validators = {
  username: {
    ...
    validate: function(username) {
      ...
      if (!this.pattern.test(username)) return 'Только латинские буквы, цифры и символ подчеркивания';
      return null;
    }
  },
  email: {
